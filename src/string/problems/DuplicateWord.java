...
public class DuplicateWord {
    ...
    public static void main(String[] args) {
        ...
        String st = "Java is a programing language. PNT is the right place to learn Java ";
    ...
    public static Set<String> duplicateWords(String input){
        ...
        for(String count : arraylist) {
            if(Collections.frequency(arraylist, count)>1) {
                System.out.println("Number of occurance of: "+count+" is: " + Collections.frequency(arraylist, count));
            }
        }
        return duplicates;
    }
